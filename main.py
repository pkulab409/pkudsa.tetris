    ...
    def turn(self):
        ...
        if self.time % 2 == 1:  # 先手玩家操作
            ...
            if battleline:
                ...
                self.combo1 = 0
            self.point1 += battlepoint[battleline] + \
                peacepoint[peaceline] + 10*empty + self.combo1
            ...
            if battleline:
                ...
                self.combo2 = 0
            self.point2 += battlepoint[battleline] + \
                peacepoint[peaceline] + 10*empty + self.combo2
